...
const state = {
   ...
   init () {
      ...
      // state.fullscreen && params.append('fullscreen', '');
      // state.panel && params.append('panel', '');
      // state.respawn && params.append('respawn', '');
      ...
      /*
      state.window.on('move', () => {
         state.fullscreen || (state.position = state.window?.getPosition());
      });
      state.position = state.window?.getPosition();
      if (state.fullscreen) {
         state.window.setResizable(true);
